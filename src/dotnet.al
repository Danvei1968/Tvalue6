dotnet
{
    assembly("Microsoft.VisualBasic")
    {
        ...
        type("Microsoft.VisualBasic.Financial"; "Financial")
        {
        }

        type("Microsoft.VisualBasic.DueDate"; "DueDate")
        {
        }
    }
    assembly("mscorlib")
    ...
    assembly("Silanis.ESL")
    {
        Version = '11.0.0.0';
        Culture = 'neutral';
        PublicKeyToken = '9b5c8938bbf1119e';

        type("Silanis.ESL.SDK.EslClient"; "EslClient")
        {
        }

        type("Silanis.ESL.SDK.DocumentPackage"; "DocumentPackage")
        {
        }

        type("Silanis.ESL.SDK.DocumentPackageStatus"; "DocumentPackageStatus")
        {
        }

        type("Silanis.ESL.SDK.SigningStatus"; "SigningStatus")
        {
        }

        type("Silanis.ESL.SDK.Builder.PackageBuilder"; "PackageBuilder")
        {
        }

        type("Silanis.ESL.SDK.DocumentPackageSettingsBuilder"; "DocumentPackageSettingsBuilder")
        {
        }

        type("Silanis.ESL.SDK.Builder.SignerBuilder"; "SignerBuilder")
        {
        }

        type("Silanis.ESL.SDK.Builder.DocumentBuilder"; "DocumentBuilder")
        {
        }

        type("Silanis.ESL.SDK.DocumentType"; "DocumentType")
        {
        }

        type("Silanis.ESL.SDK.Builder.SignatureBuilder"; "SignatureBuilder")
        {
        }

        type("Silanis.ESL.SDK.TextAnchorBuilder"; "TextAnchorBuilder")
        {
        }

        type("Silanis.ESL.SDK.TextAnchor"; "TextAnchor")
        {
        }

        type("Silanis.ESL.SDK.TextAnchorPosition"; "TextAnchorPosition")
        {
        }

        type("Silanis.ESL.SDK.PackageId"; "PackageId")
        {
        }

        type("Silanis.ESL.SDK.SenderInfoBuilder"; "SenderInfoBuilder")
        {
        }

        type("Silanis.ESL.SDK.DownloadedFile"; "DownloadedFile")
        {
        }

        type("Silanis.ESL.SDK.Services.PackageService"; "PackageService")
        {
        }
        type("Silanis.ESL.SDK.Builder.FieldBuilder"; "FieldBuilder")
        { }
        type("Silanis.ESL.SDK.ApprovalService"; "ApprovalService")
        { }
        type("Silanis.ESL.SDK.Builder.FieldValidatorBuilder"; "FieldValidatorBuilder")
        { }
        type("Silanis.ESL.SDK.CeremonyLayoutSettingsBuilder"; "CeremonyLayoutSettingsBuilder")
        { }
        type("Silanis.ESL.SDK.CeremonyLayoutSettings"; "CeremonyLayoutSettings")
        { }
        type("Silanis.ESL.SDK.FieldSummary"; "FieldSummary")
        { }
        type("Silanis.ESL.SDK.Services.FieldSummaryService"; "FieldSummaryService")
        { }
    }
    ...
    assembly("Spire.Pdf")
    {
        ...
        type("Spire.Pdf.PdfDocument"; "S4L PdfDocument")
        {
        }

        type("Spire.Pdf.Widget.PdfFormWidget"; "PdfFormWidget")
        {
        }

        type("Spire.Pdf.Fields.PdfField"; "PdfField")
        {
        }

        type("Spire.Pdf.Widget.PdfTextBoxFieldWidget"; "PdfTextBoxFieldWidget")
        {
        }

        type("Spire.Pdf.Widget.PdfCheckBoxWidgetFieldWidget"; "PdfCheckBoxWidgetFieldWidget")
        {
        }

        type("Spire.Pdf.Widget.PdfRadioButtonWidgetItem"; "PdfRadioButtonWidgetItem")
        {
        }
    }
    ...
    */
    /* not used enymore in SL62
    assembly("Microsoft.Dynamics.Nav.Integration.Office")
    {
#if BC19SL62
        Version = '19.0.0.0'; //Version change  '16.0.0.0' -> '17.0.0.0' -> 19.0.0.0
#else
        Version = '20.0.0.0'; //Version change  '16.0.0.0' -> '17.0.0.0' -> 19.0.0.0 -> 20.0.0.0
#endif
        Culture = 'neutral';
    ...
    */
    ...
    assembly("ClosedXML")
    {
        ...
        type("ClosedXML.Excel.XLWorkbook"; "XLWorkbook")
        {
        }

        type("ClosedXML.Excel.IXLWorksheet"; "IXLWorksheet")
        {
        }

        type("ClosedXML.Excel.IXLCell"; "IXLCell")
        {
        }

        type("ClosedXML.Excel.IXLRow"; "IXLRow")
        {
        }

        type("ClosedXML.Excel.IXLRange"; "IXLRange")
        {
        }

        type("ClosedXML.Excel.XLBorderStyleValues"; "XLBorderStyleValues")
        {
        }

        type("ClosedXML.Excel.XLAlignmentVerticalValues"; "XLAlignmentVerticalValues")
        {
        }
        type("ClosedXML.Excel.XLAlignmentVerticalValues"; "XLErrorStyle")
        {
        }
    }
